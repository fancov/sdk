...
S32 bsd_walk_customer_tbl(BS_INTER_MSG_WALK *pstMsg)
{
    ...
    HASH_Scan_Table(g_astCustomerTbl, ulHashIndex)
    {
        HASH_Scan_Bucket(g_astCustomerTbl, ulHashIndex, pstHashNode, HASH_NODE_S *)
        {
            ...
            dos_snprintf(szQuery, sizeof(szQuery), "SELECT count(*) FROM tbl_sip WHERE tbl_sip.customer_id=%u;", pstCustomer->ulCustomerID);
            ...
            dos_snprintf(szQuery, sizeof(szQuery), "SELECT count(*) FROM tbl_sipassign WHERE tbl_sipassign.customer_id=%u;", pstCustomer->ulCustomerID);
...
VOID bsd_save_settle_cdr(BS_INTER_MSG_CDR *pstMsg)
{
    ...
    dos_snprintf(szQuery, sizeof(szQuery), "INSERT INTO `tbl_cdr_settle` ("
                      ...
                      "`peer_ip2`,`peer_ip3`,`peer_ip4`, `res1`, `res2`)"
