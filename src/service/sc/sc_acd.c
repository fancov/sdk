...
/*
 * 函  数: U32 sc_acd_update_agent_info(SC_SCB_ST *pstSCB, U32 ulStatus, U32 ulSCBNo, S8 *szCustomerNum)
 * 功  能: 更新坐席状态
 * 参  数:
...
U32 sc_acd_update_agent_info(SC_SCB_ST *pstSCB, U32 ulStatus, U32 ulSCBNo, S8 *szCustomerNum)
{
    ...
    if (ulStatus != pstAgentQueueInfo->pstAgentInfo->ucStatus)
    {
        ...
        {
            sc_ep_agent_status_notify(pstAgentQueueInfo->pstAgentInfo, ulAction);
        }
    }
...
U32 sc_acd_update_agent_status(U32 ulAction, U32 ulAgentID, U32 ulOperatingType)
{
    ...
    switch (ulAction)
    {
        ...
        case SC_ACD_SITE_ACTION_ONLINE:
            ...
            sc_acd_agent_stat(SC_AGENT_STAT_ONLINE
                                , pstAgentQueueInfo->pstAgentInfo->ulSiteID
        ...
        case SC_ACD_SITE_ACTION_OFFLINE:
            ...
            sc_acd_agent_stat(SC_AGENT_STAT_OFFLINE
                                , pstAgentQueueInfo->pstAgentInfo->ulSiteID
                                , pstAgentQueueInfo->pstAgentInfo, 0);
        ...
        case SC_ACD_SITE_ACTION_SIGNIN:
            ...
            sc_acd_agent_stat(SC_AGENT_STAT_SIGNIN
                                , pstAgentQueueInfo->pstAgentInfo->ulSiteID
                                , pstAgentQueueInfo->pstAgentInfo
                                , 0);
        ...
        case SC_ACD_SITE_ACTION_SIGNOUT:
            ...
            sc_acd_agent_stat(SC_AGENT_STAT_SIGNOUT
                                , pstAgentQueueInfo->pstAgentInfo->ulSiteID
                                , pstAgentQueueInfo->pstAgentInfo
                                , 0);

            sc_ep_agent_status_notify(pstAgentQueueInfo->pstAgentInfo, ACD_MSG_SUBTYPE_SIGNOUT);
            break;
        ...
        case SC_ACD_SITE_ACTION_EN_QUEUE:
            ...
            sc_ep_agent_status_notify(pstAgentQueueInfo->pstAgentInfo, ACD_MSG_SUBTYPE_IDLE);
            break;
        ...
        case SC_ACD_SITE_ACTION_DN_QUEUE:
            ...
            sc_ep_agent_status_notify(pstAgentQueueInfo->pstAgentInfo, ACD_MSG_SUBTYPE_BUSY);
            break;
        ...
        case SC_ACD_SITE_ACTION_CONNECTED:
            ...
            sc_ep_agent_status_notify(pstAgentQueueInfo->pstAgentInfo, ACD_MSG_SUBTYPE_SIGNIN);
            break;
...
U32 sc_acd_get_agent_by_tt_num(SC_ACD_AGENT_INFO_ST *pstAgentInfo, S8 *szTTNumber, SC_SCB_ST *pstSCB)
{
    ...
    sc_logr_debug(NULL, SC_FUNC, "Get agnet FAIL by tt number(%s)", szTTNumber);
    return DOS_FAIL;
}
...
U32 sc_acd_singin_by_phone(S8 *szUserID, SC_SCB_ST *pstSCB, SC_AGENT_BIND_TYPE_EN enType)
{
    ...
    HASH_Scan_Table(g_pstAgentList, ulHashIndex)
    {
        HASH_Scan_Bucket(g_pstAgentList, ulHashIndex, pstHashNode, HASH_NODE_S *)
        {
            ...
            if (pstAgentData->ucBindType != enType)
            {
                continue;
            }
            ...
            if (enType == AGENT_BIND_SIP)
            {
                if (dos_strcmp(pstAgentData->szUserID, szUserID))
                {
                    continue;
                }
            }
            ...
            {
                if (dos_strcmp(pstAgentData->szTTNumber, szUserID))
                {
                    continue;
                }
            }
...
U32 sc_acd_agent_set_signin(SC_ACD_AGENT_INFO_ST *pstAgentQueueInfo, U32 ulOperatingType)
{
    ...
    {
        sc_acd_agent_stat(SC_AGENT_STAT_SIGNIN, pstAgentQueueInfo->ulSiteID, pstAgentQueueInfo, 0);
    }
...
U32 sc_acd_agent_set_signout(SC_ACD_AGENT_INFO_ST *pstAgentQueueInfo, U32 ulOperatingType)
{
    ...
    sc_acd_agent_stat(SC_AGENT_STAT_SIGNOUT, pstAgentQueueInfo->ulSiteID, pstAgentQueueInfo, 0);
...
VOID sc_acd_agent_set_logout(U64 p)
{
    ...
    if (ulOldStatus != pstAgentQueueInfo->ucStatus)
    {
        ...
        /* 更新数据库 */
        sc_acd_agent_update_status_db(pstAgentQueueInfo->ulSiteID, pstAgentQueueInfo->ucStatus, pstAgentQueueInfo->bConnected);
    }
...
U32 sc_acd_agent_update_status2(U32 ulAction, U32 ulAgentID, U32 ulOperatingType)
{
        ...
        && (ulOldStatus <= SC_ACD_IDEL || pstAgentInfo->ucStatus <= SC_ACD_IDEL))
    {
        ...
        sc_acd_agent_update_status_db(ulAgentID, pstAgentInfo->ucStatus, pstAgentInfo->bConnected);
    }
...
U32 sc_acd_save_agent_stat(SC_ACD_AGENT_INFO_ST *pstAgentInfo)
{
    ...
    for (i=0; i<2; i++)
    {
        ...
        dos_snprintf(szSQL, sizeof(szSQL),
                        ...
                        "%u, %u, %u, \"%s\", %u, %u, %u, %u, %u, %u)"
                    , time(NULL), 0, pstAgentInfo->ulSiteID, pstAgentInfo->szEmpNo, pstAgentInfo->aulGroupID[i]
