...
#
# Script for cleaning the cron log
#
...
# Define the max time the cron log can be save(in day)
MAX_TIME=30

# Define cron log root path
FILE_ROOT_PATH="/var/log"

# Define the cron log file prefix
# We cannot delete the current log (cron)
FILE_PREFIX="cron-"
FILE_SUBFIX=""
...
log_write "INFO" "Processing cron log file."
...
log_write "INFO" "Processed cron log file. Total:"$total_file", Size:"$total_size
