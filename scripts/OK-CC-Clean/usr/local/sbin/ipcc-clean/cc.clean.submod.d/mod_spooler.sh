...
#
# Script for cleaning the spooler log
#
...
# Define the max time the spooler log can be save(in day)
MAX_TIME=30

# Define spooler log root path
...
log_write "INFO" "Processing spooler log file."
...
log_write "INFO" "Processed spooler log file. Total:"$total_file", Size:"$total_size
